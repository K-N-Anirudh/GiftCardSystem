...
public class Utility {
    ...
    public static void main(String[] args)
    {
        ...
        Customer cust; boolean validName,validPassword,validPurchase,invalidType=false,cardNoExist;
        ...
        do{// For 1st menu to login or signup or purchase
            ...
            do { // To make sure choice is input and in positive
                ...
                try {
                    ...
                    if(initialChoice<=0){
                       throw new NumberRangeException("Negative No not allowed");
                    }
            ...
            switch(initialChoice)
            {
                case 1://Signup
                    ...
                    do {// Checking the Name is in specified format
                        System.out.print("\n Enter Name(Only alphabets and . allowed):");name = sc.nextLine();
                    ...
                    do { // Checking the Password in specified format
                        System.out.print("\n Enter Password(Only alphabets and digits allowed):");Password = sc.nextLine();
                ...
                case 2://Login and other activities
                    ...
                    do { // To make sure choice is input and in positive
                        invalidType=false;
                        try {
                            System.out.print("\n Enter your Id:");custId=sc.nextInt();
                            if(custId<0){
                                throw new NumberRangeException("Negative No not allowed");
                            }
                                ...
                                if (str.equals(Password)) {
                                    ...
                                    do {
                                        ...
                                        do { // To make sure choice is input and in positive
                                            invalidType=false;
                                            try {
                                                System.out.print(menu2);choiceAfterLogin=sc.nextInt();
                                        ...
                                        switch (choiceAfterLogin) {
                                            case 1://Create New GiftCard
                                                Random r = new Random(System.currentTimeMillis());// To generate random number
                                                int giftCardNo;

                                                do { //To make sure one copy of card no is there
                                                    cardNoExist = false;
                                                    giftCardNo = (10000 + r.nextInt(10000));//Make sures in 5 digit
                                                    if (cards.contains(giftCardNo)) {// Checks if card no is there
                                                        cardNoExist = true;
                                                    } else cards.add(giftCardNo);
                                                } while (cardNoExist);
                                                int giftCardPin = (1000 + r.nextInt(1000));
                                            ...
                                            case 2://Top-up Existing Card
                                                ...
                                                for (i = 0; i < accounts.get(accountNo).getCard().size(); i++) { //Traversing to giftcard array in accountvtill we get required card
                                                    if (accounts.get(accountNo).getCard().get(i).getCardNumber() == topUpCardNo) {
                                                        ...
                                                        System.out.println("Topuped succcessfully with current amount:" + accounts.get(accountNo).getCard().get(i).getAmount());
                                                    }
                ...
                case 3:
                    ...
                    validPurchase=true;// To check if amount is there and card no and pin matcing
                    attempt=0;
                    do {
                        attempt++;
                        ...
                        while (iteratorGiftCard.hasNext())// Iterating to check if email exist
                        {
                            ...
                            while (eachCard.hasNext()) {
                                ...
                                if (card.getCardNumber() == purchaseCardNo) {// Check for cardNo
                                    ...
                                    System.out.println("Card No does not exist");
                                    validPurchase = false;
                                }
                                if(!validPurchase)
                                {
